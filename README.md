...
The file `interactsh-domains-checked.txt` contains the Nuclei output for the templates `dns-interactsh-detect.yaml`, `ldap-interactsh-detect.yaml`, `smtp-interactsh-detect.yaml`, and `interact-server.yaml`.
